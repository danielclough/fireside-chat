                ...
                .map(|inference_args_from_resource| {
                    view! {
                        <Box class="api-box">
                            ...
                            <P class="under-input">"Temperature is: " {move || inference_args_from_resource.temperature}</P>
                            ...
                            <P class="under-input">"Top_p is: " {move || inference_args_from_resource.top_p}</P>
                            ...
                            <P class="under-input">"Seed is: " {move || inference_args_from_resource.seed}</P>
                            ...
                            <P class="under-input">"Sample_len is: " {move || inference_args_from_resource.sample_len}</P>

                            <P class="above-input">
                                <strong>"Repeat_penalty: "</strong>
                                "Penalty to be applied for repeating tokens, 1. means no penalty."
                            </P>
                            <NumberInput min=0.0 max=2.0 step=0.1 get=repeat_penalty set=set_repeat_penalty/>
                            <P class="under-input">
                                "Repeat_penalty is: " {move || inference_args_from_resource.repeat_penalty}
                            </P>
                            ...
                            <NumberInput min=1.0 max=999.0 step=1.0 get=repeat_last_n set=set_repeat_last_n/>
                            <P class="under-input">
                                "Repeat_last_n is: " {move || inference_args_from_resource.repeat_last_n}
                            </P>
